...
import imagesUrl from '../utils/images.js'
...
<template>
  ...
  <section class="AboutMe" id="AboutMe">
    <div class="container pb-5">
      ...
      <div class="aboutMe-content">
        <p>目前是一位約有一年半開發經驗的網頁前端工程師，在擔任工程師以前，曾任職過平面設計與行銷企劃的職位，因此對於網頁前端的美感要求以及專案進度的時程規劃，都具有一定程度的經驗。</p>
        <p>對於新技術抱有著強烈的好奇心，也樂於分享獲得的新知識，喜歡與團隊成員一起切磋討論、成長進步。</p>
      </div>
    </div>
  </section>
  ...
  <section class="Experience" id="Experience">
    <div class="container">
      ...
      <el-timeline class="pb-5">
        <ExperienceCard
          time="2022/11 - 至今"
          title="動力安全資訊股分有限公司｜前端工程師"
          content="與後端工程師協同開發專案，以及系統介面視覺優化，同時自主學習 Vue.js 前端框架，並將所學透過教育訓練的方式，引領部門同仁改以將專案使用 Vue.js 前端框架進行開發，以及建立共用元件，並透過 CI/CD 自動化部屬到公司內部私有套件庫中。"
        />
        <ExperienceCard
  ...
  <section class="Portfolio" id="Portfolio">
    <div class="container">
      ...
      <div class="row">
        <PortfolioCard
          :srcImg="images.pixelGame"
          category="Static Page"
          title="Space Inyaders。太空侵略者"
          introduce="設計以復古像素風格為主的UI界面，結合 JavaScript 編寫遊戲互動，打造經典射擊遊戲體驗"
          hrefButton="https://pennypan0111.github.io/pixel-game/pixelGame-easy.html"
        />
        <PortfolioCard
          :srcImg="images.playOne"
